import { MiddlewareAPI, Dispatch, Action, type Middleware } from 'redux';
...
const promiseMiddleware = ({ dispatch }: MiddlewareAPI) => {
...
export default promiseMiddleware as Middleware;
